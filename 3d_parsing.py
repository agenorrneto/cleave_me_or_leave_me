...
This script has been modified by Agenor Neto
'''
...
def run_dssp(pdb_path, output_dssp):
    ...
    # Setting the variable needed for running mkdssp
    d = dict(os.environ)
    d['LD_LIBRARY_PATH'] = '/home/agenor/lib/'
    
    command = ["mkdssp", "--output-format", "dssp", '-i', pdb_path, '-o', output_dssp]
    process = subprocess.call(command, env=d)
    return process
